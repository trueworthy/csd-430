...
<body>
	...
	<form method="post" action="CRUD_Update.jsp">
		...
		<select id="bookFormat" name="bookFormat">
    			...
    			<option value="MM" id="Mass Market" <%= "MM".equals(bookData.get("bookFormat")) ? "selected" : "" %>>MM</option>
    			<option value="LP" id="Large Print" <%= "OOP".equals(bookData.get("bookFormat")) ? "selected" : "" %>>OOP</option>
