...
// I decided to add more books to the list just to see what it would look like (plus I was bored one day)
		String[][] books = { 
			    ...
			    { "Of Monsters and Mainframes", "Barbara Truelove", "Science Fiction", "2025", "AUDIO", "9781666692570" },
		...
		try (java.sql.Connection conn = getConnection();
			...
			dataStringBuilder.append("<b>Error inserting data: </b>").append(e.getMessage()).append("<br />");
		}
